...
class Carousel extends BaseComponent {
  ...
  _getConfig(e) {
    return (e = { ...Default$8, ...e }), typeCheckConfig(NAME$9, e, DefaultType$8), e;
  }
  _handleSwipe() {
  ...
  _keydown(e) {
    /input|textarea/i.test(e.target.tagName) ||
      ("ArrowLeft" === e.key
        ...
        : "ArrowRight" === e.key && (e.preventDefault(), this._slide(DIRECTION_RIGHT)));
  }
  _getItemIndex(e) {
    return (
      ...
      if (
        ...
        EventHandler.one(i, "transitionend", () => {
          o.classList.remove(c, E),
            ...
            (this._isSliding = !1),
            setTimeout(() => {
              EventHandler.trigger(this._element, EVENT_SLID, { relatedTarget: o, direction: d, from: s, to: r });
            }, 0);
        }),
...
class Collapse extends BaseComponent {
  ...
  _getConfig(e) {
    return ((e = { ...Default$7, ...e }).toggle = Boolean(e.toggle)), typeCheckConfig(NAME$8, e, DefaultType$7), e;
  }
  _getDimension() {
...
class Dropdown extends BaseComponent {
  ...
  show() {
    ...
    if (!EventHandler.trigger(this._element, EVENT_SHOW$4, t).defaultPrevented) {
      ...
      "ontouchstart" in document.documentElement &&
        ...
        [].concat(...document.body.children).forEach((e) => EventHandler.on(e, "mouseover", null, function () {})),
        this._element.focus(),
    ...
    for (let n = 0, i = t.length; n < i; n++) {
      ...
      if (t[n].classList.contains("show")) {
        ...
        EventHandler.trigger(t[n], EVENT_HIDE$4, s).defaultPrevented ||
          ("ontouchstart" in document.documentElement &&
            [].concat(...document.body.children).forEach((e) => EventHandler.off(e, "mouseover", null, function () {})),
  ...
  static dataApiKeydownHandler(e) {
    ...
    if ("Escape" === e.key)
      return (
        (this.matches(SELECTOR_DATA_TOGGLE$3) ? this : SelectorEngine.prev(this, SELECTOR_DATA_TOGGLE$3)[0]).focus(),
...
class Modal extends BaseComponent {
  ...
  hide(e) {
    ...
    if (
      ...
      EventHandler.one(this._element, "transitionend", (e) => this._hideModal(e)),
        emulateTransitionEnd(this._element, e);
    } else this._hideModal();
  }
  dispose() {
    [window, this._element, this._dialog].forEach((e) => EventHandler.off(e, ".bs.modal")),
      super.dispose(),
      EventHandler.off(document, EVENT_FOCUSIN$1),
      (this._config = null),
      (this._dialog = null),
  ...
  _getConfig(e) {
    return (e = { ...Default$5, ...e }), typeCheckConfig(NAME$6, e, DefaultType$5), e;
  }
  _showElement(e) {
    const t = this._isAnimated(),
  ...
  _setScrollbar() {
    this._isBodyOverflowing &&
      (this._setElementAttributes(SELECTOR_FIXED_CONTENT$1, "paddingRight", (e) => e + this._scrollbarWidth),
...
class Tooltip extends BaseComponent {
  ...
  setElementContent(e, t) {
    if (null !== e)
      return "object" == typeof t && isElement(t)
        ...
        : void (this.config
            ? (this.config.sanitize && (t = sanitizeHtml(t, this.config.allowList, this.config.sanitizeFn)),
              (e.innerHTML = t))
            : (e.textContent = t));
  }
  getTitle() {
    ...
    return (
      e || (e = "function" == typeof this.config.title ? this.config.title.call(this._element) : this.config.title), e
    );
  }
  updateAttachment(e) {
  ...
  _setListeners() {
    this.config.trigger.split(" ").forEach((e) => {
      if ("click" === e)
        EventHandler.on(this._element, this.constructor.Event.CLICK, this.config.selector, (e) => this.toggle(e));
      else if ("manual" !== e) {
        ...
        EventHandler.on(this._element, t, this.config.selector, (e) => this._enter(e)),
          EventHandler.on(this._element, n, this.config.selector, (e) => this._leave(e));
      }
    }),
  ...
  _getConfig(e) {
    ...
    return (
      ...
      "number" == typeof (e = { ...this.constructor.Default, ...t, ...("object" == typeof e && e ? e : {}) }).delay &&
...
class ScrollSpy extends BaseComponent {
  ...
  _getConfig(e) {
    if (
      "string" != typeof (e = { ...Default$1, ...("object" == typeof e && e ? e : {}) }).target &&
      isElement(e.target)
    ) {
      let { id: t } = e.target;
...
EventHandler.on(window, EVENT_LOAD_DATA_API, () => {
  SelectorEngine.find(SELECTOR_DATA_SPY).forEach((e) => new ScrollSpy(e, Manipulator.getDataAttributes(e)));
}),
  ...
  _transitionComplete(e, t, n) {
    ...
    e.classList.add("active"),
      ...
      e.parentNode &&
        ...
        (e.closest(".dropdown") && SelectorEngine.find(".dropdown-toggle").forEach((e) => e.classList.add("active")),
